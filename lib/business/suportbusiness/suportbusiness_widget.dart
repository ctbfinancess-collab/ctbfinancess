...
import '/components/email_supportbusiness/email_supportbusiness_widget.dart';
import '/components/support_requestbusiness/support_requestbusiness_widget.dart';
import '/components/supportphone_business/supportphone_business_widget.dart';
...
import 'suportbusiness_model.dart';
export 'suportbusiness_model.dart';

class SuportbusinessWidget extends StatefulWidget {
  const SuportbusinessWidget({super.key});

  static String routeName = 'suportbusiness';
  static String routePath = '/suportbusiness';

  @override
  State<SuportbusinessWidget> createState() => _SuportbusinessWidgetState();
}

class _SuportbusinessWidgetState extends State<SuportbusinessWidget>
    with TickerProviderStateMixin {
  late SuportbusinessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SuportbusinessModel());
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'cxb662n9' /* Your business account details ... */,
                                          ),
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            labelText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              '11wzkhg6' /* Short Description of what is g... */,
                                            ),
                                            labelStyle: FlutterFlowTheme.of(
                                                    context)
                                                .displaySmall
                                            ...
                                            onTap: () async {
                                              ...
                                              if (selectedMedia != null &&
                                                ...
                                                try {
                                                  ...
                                                  _model.isDataUploading_uploadDataB35 =
                                                      false;
                                                }
                                                if (selectedUploadedFiles
                                                    ...
                                                    downloadUrls.length ==
                                                        selectedMedia.length) {
                                                  safeSetState(() {
                                                    _model.uploadedLocalFile_uploadDataB35 =
                                                        selectedUploadedFiles
                                                            .first;
                                                    _model.uploadedFileUrl_uploadDataB35 =
                                                        downloadUrls.first;
                                                  });
                                                } else {
                                                  safeSetState(() {});
                                                        ...
                                                        .authenticate(
                                                            localizedReason:
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                  'z7h23dkk' /* Biometric Verification */,
                                                ));
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'h1ui9ydz' /* Your business account details ... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            labelText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              'fqoocazn' /* Short Description of what is g... */,
                                            ),
                                            labelStyle: FlutterFlowTheme.of(
                                                    context)
                                                .displaySmall
                                            ...
                                            onTap: () async {
                                              ...
                                              if (selectedMedia != null &&
                                                ...
                                                try {
                                                  ...
                                                  _model.isDataUploading_uploadData66r =
                                                      false;
                                                }
                                                if (selectedUploadedFiles
                                                            .length ==
                                                    ...
                                                    downloadUrls.length ==
                                                        selectedMedia.length) {
                                                  safeSetState(() {
                                                    _model.uploadedLocalFile_uploadData66r =
                                                        selectedUploadedFiles
                                                            .first;
                                                    _model.uploadedFileUrl_uploadData66r =
                                                        downloadUrls.first;
                                                  });
                                                } else {
                                                  safeSetState(() {});
