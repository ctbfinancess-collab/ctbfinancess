...
import 'register_accountbusiness_model.dart';
export 'register_accountbusiness_model.dart';

class RegisterAccountbusinessWidget extends StatefulWidget {
  const RegisterAccountbusinessWidget({super.key});

  static String routeName = 'registerAccountbusiness';
  static String routePath = '/registerAccountbusiness';

  @override
  State<RegisterAccountbusinessWidget> createState() =>
      _RegisterAccountbusinessWidgetState();
}

class _RegisterAccountbusinessWidgetState
    extends State<RegisterAccountbusinessWidget> {
  late RegisterAccountbusinessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RegisterAccountbusinessModel());
                            ...
                            child: Row(
                              ...
                              children: [
                                if (!(Theme.of(context).brightness ==
                                    Brightness.dark))
                                  Image.asset(
                                    'assets/images/Tela28_transparente.png',
                                    width:
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              '8i5luqvp' /* Create your account below. */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .titleMedium
                                                .override(
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          safeSetState(() {});
                                          await AccessCodeCall.call(
                                            receiver: _model
                                                .emailAddressTextController1
                                                .text,
                                            code: FFAppState().accesskey,
                                          );

                                          context.pushNamedAuth(
                                            AccesskeyverificationBusinessWidget
                                                .routeName,
                                            context.mounted,
                                            queryParameters: {
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'aswzo0ec' /* Already have an account? */,
                                                    ),
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '3mwkhiti' /* Create your account below. */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .titleMedium
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          '1z28uuk9' /* Already have an account? */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
