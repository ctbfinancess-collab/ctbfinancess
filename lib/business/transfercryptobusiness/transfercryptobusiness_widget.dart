...
import 'transfercryptobusiness_model.dart';
export 'transfercryptobusiness_model.dart';

class TransfercryptobusinessWidget extends StatefulWidget {
  const TransfercryptobusinessWidget({super.key});

  static String routeName = 'transfercryptobusiness';
  static String routePath = '/transactioncryptobusiness';

  @override
  State<TransfercryptobusinessWidget> createState() =>
      _TransfercryptobusinessWidgetState();
}

class _TransfercryptobusinessWidgetState
    extends State<TransfercryptobusinessWidget> with TickerProviderStateMixin {
  late TransfercryptobusinessModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransfercryptobusinessModel());
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'kpq9we1i' /* Your business account details ... */,
                                          ),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'sw3npxha' /* Record of Transactions */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                      ...
                                      Padding(
                                        ...
                                        child: FlutterFlowDropDown<String>(
                                          ...
                                          hintText: FFLocalizations.of(context)
                                              .getText(
                                            '2qhlf1uh' /* Crypto That Will be Transferre... */,
                                          ),
                                          icon: Icon(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'wwqk78ob' /* Your account balance is: */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodySmall
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                                        ...
                                                        return Padding(
                                                          ...
                                                          child: Container(
                                                            height: MediaQuery
                                                                ...
                                                                0.25,
                                                            child:
                                                                CompleteCryptoTransferbusinessWidget(),
                                                          ),
                                                        );
                                                      },
                                                    ).then((value) =>
                                    ...
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'z2i1d3ux' /* Tap above to complete transfer */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            '5ft410ha' /* Your business account details ... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      '6q5pa2iy' /* Record of Transactions */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: FlutterFlowDropDown<String>(
                                          ...
                                          hintText: FFLocalizations.of(context)
                                              .getText(
                                            '56e8riun' /* Crypto That Will be Transferre... */,
                                          ),
                                          icon: Icon(
                                            Icons.keyboard_arrow_down_rounded,
                                            color: FlutterFlowTheme.of(context)
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'bmtgnf83' /* Your account balance is: */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodySmall
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        '5y9af1ll' /* Tap above to complete transfer */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
