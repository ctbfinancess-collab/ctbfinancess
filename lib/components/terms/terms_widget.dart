                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            '8d44pu2r' /* You accept the terms and condi... */,
                          ),
                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        ...
                        context.pushNamed(WaitingpageWidget.routeName);

                        safeSetState(() {});
                      },
                      text: FFLocalizations.of(context).getText(
                        'rgfuc9iu' /* Yes Accepted */,
                      ),
                      options: FFButtonOptions(
                        width: 150.0,
                        height: 50.0,
