...
import 'schema/conta_record.dart';
import 'schema/payments_record.dart';
import 'schema/budgets_record.dart';
import 'schema/userbusiness_record.dart';
...
export 'schema/conta_record.dart';
export 'schema/payments_record.dart';
export 'schema/budgets_record.dart';
export 'schema/userbusiness_record.dart';
...
/// Functions to query ContaRecords (as a Stream and as a Future).
Future<int> queryContaRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ContaRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ContaRecord>> queryContaRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ContaRecord.collection,
      ContaRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ContaRecord>> queryContaRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query UserbusinessRecords (as a Stream and as a Future).
Future<int> queryUserbusinessRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      UserbusinessRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<UserbusinessRecord>> queryUserbusinessRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      UserbusinessRecord.collection,
      UserbusinessRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<UserbusinessRecord>> queryUserbusinessRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
