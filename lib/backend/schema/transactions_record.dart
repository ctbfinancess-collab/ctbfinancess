...
class TransactionsRecord extends FirestoreRecord {
  ...
  // "Prohibited" field.
  bool? _prohibited;
  bool get prohibited => _prohibited ?? false;
  bool hasProhibited() => _prohibited != null;
  ...
  void _initializeFields() {
    ...
    _prohibited = snapshotData['Prohibited'] as bool?;
    _value = castToType<double>(snapshotData['value']);
    _category1 = snapshotData['category1'] as String?;
  }
...
class TransactionsRecordDocumentEquality
  ...
  bool equals(TransactionsRecord? e1, TransactionsRecord? e2) {
    ...
    return e1?.transactionName == e2?.transactionName &&
        ...
        e1?.prohibited == e2?.prohibited &&
        e1?.value == e2?.value &&
        e1?.category1 == e2?.category1;
  }
