...
import 'activitycrypto_model.dart';
export 'activitycrypto_model.dart';

class ActivitycryptoWidget extends StatefulWidget {
  const ActivitycryptoWidget({super.key});

  static String routeName = 'Activitycrypto';
  static String routePath = '/Activitycrypto';

  @override
  State<ActivitycryptoWidget> createState() => _ActivitycryptoWidgetState();
}

class _ActivitycryptoWidgetState extends State<ActivitycryptoWidget> {
  late ActivitycryptoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ActivitycryptoModel());
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'yvwtdfjk' /* Your account Details are below... */,
                                          ),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'nv8nejxl' /* Crypto Transaction Record */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'pm63o0t5' /* Your account Details are below... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      '7orcj4c5' /* Crypto Transaction Record */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
