                ...
                builder: (context, snapshot) {
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: EdgeInsetsDirectional.fromSTEB(
                            200.0, 30.0, 200.0, 0.0),
                        child: Text(
                          FFLocalizations.of(context).getText(
                            '41ty30ou' /* Choose what notifcations you w... */,
                          ),
                      ...
                      Padding(
                        ...
                        child: Material(
                          ...
                          child: SwitchListTile.adaptive(
                            ...
                            subtitle: Text(
                              FFLocalizations.of(context).getText(
                                '7a5ibvdq' /* Receive Push notifications fro... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                      ...
                      Padding(
                        ...
                        child: Material(
                          ...
                          child: SwitchListTile.adaptive(
                            ...
                            subtitle: Text(
                              FFLocalizations.of(context).getText(
                                '555blv11' /* Receive email notifications fr... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                      ...
                      Padding(
                        ...
                        child: Material(
                          ...
                          child: SwitchListTile.adaptive(
                            ...
                            subtitle: Text(
                              FFLocalizations.of(context).getText(
                                'hhqn3kdn' /* Allow us to track your locatio... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
